...
class ApplicationModel(models.Model):
    ...
    cellphone_number = models.CharField(max_length = 264, blank = False, null = False)
    ...
    college_score = models.CharField(max_length = 264, blank = True, null = True)
...
class DelegationRequestModel(models.Model):
    ...
    sell_prediction_package = models.CharField(max_length = 264, blank = True, null = True)
    sell_prediction_radiator = models.CharField(max_length = 264, blank = True, null = True)
    sell_prediction_waterheater = models.CharField(max_length = 264, blank = True, null = True)
