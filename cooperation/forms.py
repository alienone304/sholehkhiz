...
class DelegationRequestForm(forms.ModelForm):
    class Meta():
        ...
        widgets = {
            ...
            'age': forms.TextInput(attrs={'class':'uk-input fHarmattan redC-text','placeholder':'سن'},),
            ...
            'phone_number': forms.TextInput(attrs={'class':'uk-input fHarmattan redC-text','placeholder':'شماره تلفن ثابت'},),
            'cellphone_number': forms.TextInput(attrs={'class':'uk-input fHarmattan redC-text','placeholder':'شماره تلفن همراه'},),
            'address': forms.Textarea(attrs={'class':'uk-textarea fHarmattan','rows':'4','placeholder':'آدرس'},),
            'area': forms.TextInput(attrs={'class':'uk-input fHarmattan redC-text','placeholder':'متراژ'},),
            ...
            'fax_number': forms.TextInput(attrs={'class':'uk-input fHarmattan redC-text','placeholder':'شماره تلفن فکس'},),
...
class ApplicationForm(forms.ModelForm):
    class Meta():
        ...
        widgets = {
            ...
            'last_name': forms.TextInput(attrs={'class':'uk-input fHarmattan redC-text','placeholder':'نام خانوادگی'},),
            'email': forms.EmailInput(attrs={'class':'uk-input fHarmattan redC-text','placeholder':'ایمیل'},),
            'id_number': forms.TextInput(attrs={'class':'uk-input fHarmattan redC-text','placeholder':'شماره شناسنامه یا کد ملی'},),
            'age': forms.TextInput(attrs={'class':'uk-input fHarmattan redC-text','placeholder':'سن'},),
            ...
            'college_score': forms.TextInput(attrs={'class':'uk-input fHarmattan redC-text','placeholder':'نمره ی تحصیلی'},),
